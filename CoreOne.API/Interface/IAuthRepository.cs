...
namespace CoreOne.API.Interfaces
{
    ...
    {
        (bool Success, string Message, User User, string Token, List<UserAccessViewModel> AccessList) Login(string userName, string password, string ipAddress);
        ...
        (bool Ok, string Message, string Token) ExchangeCacheKeyForToken(string cacheKey, int appId, string? callerIp );
